...
describe('Combinaison e2e test', () => {
  ...
  it('should load Combinaisons', async () => {
    ...
    expect(await combinaisonComponentsPage.getTitle()).to.eq('eComGucApp.combinaison.home.title');
  });
  ...
  it('should load create Combinaison page', async () => {
    ...
    expect(await combinaisonUpdatePage.getPageTitle()).to.eq('eComGucApp.combinaison.home.createOrEditLabel');
  ...
  it('should create and save Combinaisons', async () => {
    ...
    await combinaisonComponentsPage.clickOnCreateButton();
    await promise.all([combinaisonUpdatePage.tailleSelectLastOption(), combinaisonUpdatePage.setNombreInput('5')]);
    expect(await combinaisonUpdatePage.getNombreInput()).to.eq('5', 'Expected nombre value to be equals to 5');
  ...
  it('should delete last Combinaison', async () => {
    ...
    expect(await combinaisonDeleteDialog.getDialogTitle()).to.eq('eComGucApp.combinaison.delete.question');
