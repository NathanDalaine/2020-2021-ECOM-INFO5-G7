...
describe('UserProfile e2e test', () => {
  ...
  it('should load UserProfiles', async () => {
    ...
    expect(await userProfileComponentsPage.getTitle()).to.eq('ecomgucvoileApp.userProfile.home.title');
  });
  ...
  it('should load create UserProfile page', async () => {
    ...
    expect(await userProfileUpdatePage.getPageTitle()).to.eq('ecomgucvoileApp.userProfile.home.createOrEditLabel');
  ...
  it('should delete last UserProfile', async () => {
    ...
    expect(await userProfileDeleteDialog.getDialogTitle()).to.eq('ecomgucvoileApp.userProfile.delete.question');
