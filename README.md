...
The application is developed by Jérémy Masson, Nathan Dalaine, Baptise Betend, Maxence Brès, Antoine Rivoire and Tom Solvery.

This application is intended for the GUC Voile and sets up an online windsurfing reservation system.

The application was generated by Jhipster (Angular/Spring/PostgreSQL).

This repository reflects the progress of the project.
